...
<!--        <div class="nav-md">-->
<!--            <span class="mdl-layout-title"><!--Apertamente--> --><?php //echo $_SESSION[KEY_LOGGED_IN] ?><!--</span>-->
<!--        </div>-->
        <nav class="mdl-navigation">
            <a class="mdl-navigation__link" href=""><i class="material-icons md-ip">list</i> Lista
                esercenti</a>
            <a class="mdl-navigation__link" href="localhost/ListaEsercenti"><i class="material-icons md-ip">person_add</i>
